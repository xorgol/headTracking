!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(e)
    : ((t = "undefined" != typeof globalThis ? globalThis : t || self).OSC =
        e());
})(this, function () {
  "use strict";
  function t(t, e) {
  ...
  function j(t) {
    if (!v(t)) throw new Error("OSC prepareRegExPattern() needs strings");
    return t
      .replace(/\./g, "\\.")
      .replace(/\(/g, "\\(")
      .replace(/\)/g, "\\)")
  ...
  var B = (function () {
      function t() {
        n(this, t), (this.data = []), (this.byteLength = 0);
      }
      return (
        o(t, [
          {
    ...
    x = (function () {
      function t(e) {
        n(this, t), (this.value = e), (this.offset = 0);
      }
      return (
        o(t, [
          {
        ...
        o(r, [
          {
            key: "pack",
            value: function () {
              return h(a(r.prototype), "pack", this).call(this, "setInt32", 4);
            },
          },
          {
            key: "unpack",
            value: function (t) {
              var e =
                arguments.length > 1 && void 0 !== arguments[1]
                  ? arguments[1]
                  : 0;
              return h(a(r.prototype), "unpack", this).call(
                this,
                t,
                "getInt32",
                4,
    ...
    M = "utf-8";
  function T(t) {
    if (P("Buffer")) return Buffer.from(t).toString(M);
    if (P("TextDecoder")) return new TextDecoder(M).decode(new Int8Array(t));
    for (var e = "", n = 0; n < t.length; n += 65537)
      e += String.fromCharCode.apply(null, t.slice(n, n + 65537));
    return e;
  }
  var L = (function (t) {
      s(r, t);
        ...
        o(r, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (this.offset = C(r)), (this.value = T(o)), this.offset;
            },
          },
        ]),
        r
    ...
    U = (function () {
      function t() {
        ...
        (this.seconds = e), (this.fractions = r);
      }
      return (
        o(t, [
          {
            ...
            value: function (t) {
              ...
              if ("number" == typeof t) {
                ...
                return (
                  (this.seconds = n + N),
                  (this.fractions = Math.round(V * (e - n))),
                  t
                );
              }
              return (
                1e3 * ((e = this.seconds - N) + Math.round(this.fractions / V))
              );
            },
          },
        ]),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              var n = t.getUint32(e, !1),
                r = t.getUint32(e + 4, !1);
              return (
                (this.value = new U(n, r)), (this.offset = e + 8), this.offset
              );
            },
          },
        ]),
        ...
        o(r, [
          {
            key: "pack",
            value: function () {
              return h(a(r.prototype), "pack", this).call(
                this,
                "setFloat32",
                4
              );
    ...
    z = BigInt("9223372036854775807"),
    G = BigInt("-9223372036854775808"),
    Z = (function (t) {
      s(r, t);
      var e = f(r);
      function r(t) {
        if ((n(this, r), t && "bigint" != typeof t))
          throw new Error(
        ...
        var o;
        return t && (o = BigInt.asIntN(64, t)), e.call(this, o);
      }
      return (
        o(r, [
          {
    ...
    J = (function (t) {
      ...
      function r(t) {
        ...
        var o;
        return t && (o = BigInt.asUintN(64, t)), e.call(this, o);
      }
      return (
        o(r, [
          {
        ...
        o(t, [
          ...
          },
          {
            ...
            value: function () {
              ...
              var e = new B();
              if (
                (e.add(new L(this.address)),
                e.add(new L(",".concat(this.types))),
                this.args.length > 0)
              ) {
                var n;
                ...
                this.args.forEach(function (r, o) {
                  var i = t.types[o];
                  if ("i" === i) n = new H(r);
                  else if ("h" === i) n = new Z(r);
                  else if ("t" === i) n = new J(r);
                  else if ("f" === i) n = new R(r);
                  else if ("d" === i) n = new F(r);
                  else if ("s" === i) n = new L(r);
                  else if ("b" === i) n = new _(r);
                  else if ("T" === i) n = K;
                  else if ("F" === i) n = Q;
                  else if ("N" === i) n = X;
                  else {
          ...
          },
          {
            ...
            value: function (t) {
              ...
              for (
                var o, i, s = r.offset, a = [], u = 1;
                u < r.value.length;
                u += 1
              ) {
                if (((o = null), "i" === (i = r.value[u]))) o = new H();
                else if ("h" === i) o = new Z();
                else if ("t" === i) o = new J();
                else if ("f" === i) o = new R();
                else if ("d" === i) o = new F();
                ...
                else if ("T" === i) a.push(K);
                else if ("F" === i) a.push(Q);
                else if ("N" === i) a.push(X);
                else {
                  if ("I" !== i)
                    throw new Error(
                      "OSC Message found unsupported argument type"
                    );
                  a.push(Y);
                }
    ...
    tt = (function (t) {
      ...
      function r(t) {
        ...
        for (
          ...
          a[u - 1] = arguments[u];
        return (
          a.length > 0 && a[0] instanceof Array && (i = a.shift()),
          (o = e.call(this, t, i)),
          a.length > 0 &&
            ((o.types = a
              .map(function (t) {
        ...
        o(r, [
          {
            key: "add",
            value: function (t) {
              h(a(r.prototype), "add", this).call(this, I(t), t);
            },
          },
        ]),
        r
    ...
    nt = (function () {
      function t() {
        ...
        for (var r = arguments.length, o = new Array(r), i = 0; i < r; i++)
          o[i] = arguments[i];
        o.length > 0 &&
          (o[0] instanceof Date || p(o[0])
            ? (this.timetag = new W(o[0]))
            : g(o[0])
            ? (o[0].forEach(function (t) {
                e.add(t);
              }),
              o.length > 1 &&
                (o[1] instanceof Date || p(o[1])) &&
                (this.timetag = new W(o[1])))
        ...
        o(t, [
          {
            ...
            value: function (t) {
              ...
              this.timetag = new W(t);
            },
          },
          {
            key: "add",
            value: function (e) {
              if (!(e instanceof tt || e instanceof t))
                throw new Error(
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                t.add(new L(et)),
                this.timetag || (this.timetag = new W()),
                t.add(this.timetag),
                this.bundleElements.forEach(function (e) {
                  t.add(new H(e.pack().byteLength)), t.add(e);
                }),
                t.merge()
              );
            },
          },
          {
            ...
            value: function (e) {
              ...
              for (this.bundleElements = []; i < e.byteLength; ) {
                ...
                var u = void 0;
                s.unpack(e, i),
                  (i = (u = s.value === et ? new t() : new tt()).unpack(e, i)),
                  this.bundleElements.push(u);
              }
    ...
    rt = (function () {
      function t(e) {
        if ((n(this, t), e && !(e instanceof tt || e instanceof nt)))
        ...
        o(t, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                r.unpack(t, e),
                (n = r.value === et ? new nt() : new tt()).unpack(t, e),
    ...
    ot = { discardLateMessages: !1 },
    it = (function () {
      function t(r) {
        n(this, t),
          (this.options = e(e({}, ot), r)),
        ...
        o(t, [
          {
            ...
            value: function (t, e) {
              ...
              if (t.value instanceof nt) {
                var r = t.value;
                return r.bundleElements.forEach(function (t) {
                  if (t instanceof nt) {
                    if (
                      r.timetag.value.timestamp() < t.timetag.value.timestamp()
                    )
                      throw new Error(
          ...
          },
          {
            ...
            value: function (t, e, n) {
              var r = !1;
              if (v(t) && t in this.eventHandlers)
                return (
              ...
              return (
                o.forEach(function (o) {
                  var s = !1,
                    a = new RegExp(j(D(t)), "g");
                  if ((a.test(o) && o.length === a.lastIndex && (s = !0), !s)) {
                    var u = new RegExp(j(D(o)), "g");
          ...
          },
          {
            ...
            value: function () {
              ...
              if (e[0] instanceof rt) return this.dispatch(e[0], e[1]);
              if (e[0] instanceof nt || e[0] instanceof tt)
                return this.dispatch(new rt(e[0]), e[1]);
              if (!v(e[0])) {
                var r = new rt();
                return r.unpack(A(e[0])), this.dispatch(r, e[1]);
              }
              var o = e[0],
                i = null;
              e.length > 1 && (i = e[1]);
              ...
              if ((e.length >= 3 && (a = e[3]), s)) {
                var u = Date.now();
                if (u > s && !this.options.discardLateMessages)
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              if (v(t) && t in this.eventHandlers)
                return this.eventHandlers[t].push(n), this.uuid;
              var r = D(t);
              return (
                r in this.addressHandlers || (this.addressHandlers[r] = []),
                this.addressHandlers[r].push(n),
                this.uuid
              );
            },
          },
    ...
    st = (function () {
      function t() {
        if ((n(this, t), this.constructor === t))
          throw new Error(
            "Plugin is an abstract class. Please create or use an implementation!"
          );
      }
      return (
        o(t, [
    ...
    lt = (function (t) {
      ...
      function i() {
        throw (
          (n(this, i),
          r.call(this),
          new Error("DatagramPlugin can not be used in browser context"))
        );
      }
      return (
        o(i, [
              ...
              var t = this,
                n =
                  arguments.length > 0 && void 0 !== arguments[0]
                    ? arguments[0]
                    : {},
                r = e(e({}, this.options.open), n),
                o = r.port,
                i = r.exclusive;
              (this.socketStatus = at),
                this.socket.bind(
                  { address: r.host, port: o, exclusive: i },
                  function () {
                    (t.socketStatus = ut), t.notify("open");
                  }
                );
            },
          },
          {
            ...
            value: function () {
              var t = this;
              (this.socketStatus = ct),
                this.socket.close(function () {
                  (t.socketStatus = ft), t.notify("close");
                });
            },
          },
          {
  ...
  function kt(t, n) {
    return e(
      ...
      {},
      {
        udpServer: e(e(e({}, gt.udpServer), t.udpServer), n.udpServer),
        udpClient: e(e(e({}, gt.udpClient), t.udpClient), n.udpClient),
        wsServer: e(e(e({}, gt.wsServer), t.wsServer), n.wsServer),
      }
    );
  }
  var bt = (function (t) {
      ...
      function r() {
        throw (
          (n(this, r),
          e.call(this),
          new Error("BridgePlugin can not be used in browser context"))
        );
      }
      return (
        o(r, [
              ...
              (this.socketStatus = dt),
                this.socket.bind(
                  ...
                  function () {
                    var e = {};
                    n.wsServer.server
                      ? (e.server = n.wsServer.server)
                      : (e = n.wsServer),
                      (t.websocket = new pt(e)),
                      (t.websocket.binaryType = "arraybuffer"),
                      t.websocket.on("listening", function () {
                        (t.socketStatus = vt), t.notify("open");
                      }),
          ...
          },
          {
            ...
            value: function () {
              var t = this;
              (this.socketStatus = wt),
                this.socket.close(function () {
                  t.websocket.close(function () {
                    (t.socketStatus = yt), t.notify("close");
                  });
                });
            },
          },
    ...
    Ot = 2,
    Ct = 3,
    Pt = { host: "localhost", port: 8080, secure: !1, protocol: [] },
    At = (function (t) {
      s(i, t);
      var r = f(i);
      function i(t) {
        var o;
        if ((n(this, i), (o = r.call(this)), !ht))
        ...
        o(i, [
          ...
          },
          {
            ...
            value: function () {
              ...
              (this.socket = new ht(
                "".concat(u, "://").concat(i, ":").concat(o),
                a
              )),
                (this.socket.binaryType = "arraybuffer"),
                (this.socketStatus = St),
                (this.socket.onopen = function () {
                  (t.socketStatus = Et), t.notify("open");
                }),
                (this.socket.onclose = function () {
                  (t.socketStatus = Ct), t.notify("close");
                }),
          ...
          },
          {
            key: "close",
            value: function () {
              (this.socketStatus = Ot), this.socket.close();
            },
          },
          {
            key: "send",
    ...
    xt = (function (t) {
      ...
      function i(t) {
        throw (
          (n(this, i),
          r.call(this),
          new Error("WebsocketServerPlugin can not be used in browser context"))
        );
      }
      return (
        o(i, [
          ...
          },
          {
            ...
            value: function () {
              ...
              this.socket && this.close(),
                r.server
                  ? (this.socket = new pt({ server: r.server }))
                  : (this.socket = new pt({ host: i, port: o })),
                (this.socket.binaryType = "arraybuffer"),
                (this.socketStatus = It),
          ...
          },
          {
            ...
            value: function () {
              ...
              (this.socketStatus = jt),
                this.socket.close(function () {
                  (t.socketStatus = Bt), t.notify("close");
                });
            },
          },
          {
        ...
        o(t, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (!this.options.plugin || !b(this.options.plugin.open))
          ...
          },
          {
            key: "status",
            value: function () {
              if (!this.options.plugin || !b(this.options.plugin.status))
          ...
          },
          {
            key: "close",
            value: function () {
              if (!this.options.plugin || !b(this.options.plugin.close))
          ...
          },
          {
            key: "send",
            value: function (t, e) {
              if (!this.options.plugin || !b(this.options.plugin.send))
  ...
  return (
    ...
    (Mt.TypedMessage = $),
    (Mt.Plugin = st),
    (Mt.DatagramPlugin = lt),
    (Mt.WebsocketClientPlugin = At),
    (Mt.WebsocketServerPlugin = xt),
    (Mt.BridgePlugin = bt),
    Mt
  );
});
